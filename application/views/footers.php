        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
              ...
              <section class="widget widget-links widget-light-skin">
                <h3 class="widget-title">Pembeli</h3>
                <ul>
            ...
            <div class="col-lg-3 col-md-6">
              ...
              <section class="widget widget-links widget-light-skin">
                <h3 class="widget-title">Penjual</h3>
                <ul>
                  <li><a href="#">Cara Manjual</a></li>
                  <li><a href="#">Keuntungan Menjual</a></li>
          ...
          <div class="row">
            <div class="col-md-7 padding-bottom-1x">
              <!-- Payment Methods-->
               <h3 class="widget-title">Metode Pemnayaran</h3> 
