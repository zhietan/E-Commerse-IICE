          ...
          <div class="d-flex flex-column fh-section py-5 px-3 justify-content-center align-items-center">
            ...
            <div class="form-group">
              <div align="left">
                  ...
                  <input class="form-control form-control-sm" autofocus="autofocus" type="text" required="required" id="fullname" name="fullname" placeholder="Nama Lengkap"><span class="input-group-addon"><i class="icon-head"></i></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                  <input class="form-control form-control-sm" type="text" required="required" id="usertelephone" name="usertelephone" placeholder=""><span class="input-group-addon"><i class="icon-phone"></i></span>
                  </div>
                </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                  <input class="form-control form-control-sm" type="email" required="required" id="useremail" name="useremail" placeholder=""><span class="input-group-addon"><i class="icon-mail"></i></span>
                </div>
                </div>
                </div>
                <div align="left">
                <div class="form-group">
                  ...
                  <div class="input-group">
                  <input class="form-control form-control-sm" type="password" required="required" id="userpassword" name="userpassword" placeholder=""><span class="input-group-addon"><i class="icon-lock"></i></span>
                </div>
                </div>
                </div>
              </div>
