...
<div class="offcanvas-wrapper">
      ...
      <div class="row no-gutters">
        <div class="col-md-6 fh-section" style="background-image: url(img/logo.png);"><span class="overlay" style="background-color: #F3E2A9; opacity: .85;"></span>
          <div class="d-flex flex-column fh-section py-5 px-3 justify-content-between">
            ...
            <div align="center">
               <div class="col-xl-4 col-md-8 col-sm-8"><a class="btn btn-primary facebook-btn" href="#"><i class="socicon-facebook"></i>&nbsp;Daftar dengan Facebook</a></div>
                <div class="col-xl-4 col-md-8 col-sm-8"><a class="btn btn-primary google-btn" href="#"><i class="socicon-googleplus"></i>&nbsp;Daftar dengan Google+</a></div>
          ...
          <div class="d-flex flex-column fh-section py-5 px-3 justify-content-center align-items-center">
            ...
            <div class="form-group">
              <div align="left">
                ...
                <div align="left">
                <div class="form-group">
                  <label for="small-pill-input">Password</label>
                  <div class="input-group">
