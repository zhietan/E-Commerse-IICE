          ...
          <table class="table">
            <thead>
              <tr>
                ...
                <th class="text-center"><a class="btn btn-sm btn-outline-danger" href="#">Bersihkan Keranjang</a></th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td>
                  <div class="product-item"><a class="product-thumb" href="shop-single.html"><img src="<?php echo base_url();?>assets/img/shop/cart/01.jpg" alt="Product"></a>
              ...
              <tr>
                <td>
                  <div class="product-item"><a class="product-thumb" href="shop-single.html"><img src="<?php echo base_url();?>assets/img/shop/cart/02.jpg" alt="Product"></a>
                    <div class="product-info">
              ...
              <tr>
                <td>
                  <div class="product-item"><a class="product-thumb" href="shop-single.html"><img src="<?php echo base_url();?>assets/img/shop/cart/03.jpg" alt="Product"></a>
                    <div class="product-info">
        ...
        <div class="shopping-cart-footer">
          <div class="column">
            <form class="coupon-form" method="post">
              <input class="form-control form-control-sm" type="text" placeholder="Kode Kupon" required>
              <button class="btn btn-outline-primary btn-sm" type="submit">Apply Coupon</button>
            </form>
          </div>
          <div class="column text-lg">Subtotal: <span class="text-medium">RP. 289.68</span></div>
        </div>
        <div class="shopping-cart-footer">
          <div class="column"><a class="btn btn-outline-secondary" href="shop- -ls.html"><i class="icon-arrow-left"></i>&nbsp;Belanja Lagi ?</a></div>
          ...
          <div class="grid-item">
            <div class="product-card">
              ...
              <div class="product-buttons">
                ...
                <button class="btn btn-outline-primary btn-sm" data-toast data-toast-type="success" data-toast-position="topRight" data-toast-icon="icon-circle-check" data-toast-title="Product" data-toast-message="successfuly added to cart!">Beli</button>
              </div>
            </div>
          </div>
          <!-- Product-->
