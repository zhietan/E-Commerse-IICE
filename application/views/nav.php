                  ...
                  <div class="">
                    <form>
                      <div class="form-group">
                       <input class="form-control form-control-sm" id="small-pill-input" type="text" placeholder="Name" required>
                      </div>
                        <div class="form-group">
                        <input class="form-control form-control-sm" id="small-pill-input" type="email" placeholder="Email Address" required>
                        </div>
                    </form>
