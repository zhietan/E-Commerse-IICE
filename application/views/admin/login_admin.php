...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url()."admin/login_admin"; ?>">
      <img src="<?php echo base_url(); ?>assets/gambar/iice-logo.png" alt="logo iice">
    </a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <?php 
      if (isset($_SESSION['info'])) {
        echo '<p class="login-box-msg" style="color:red;"><b>'.$_SESSION['info'].'</b></p>';
      }else{
        echo '<p class="login-box-msg">Sign in to start your session</p>';
      }
    ?>
    <form action="<?php echo base_url(); ?>admin/login_admin/verifikasi_user" method="post">
    ...
    <!-- <div class="social-auth-links text-center">
      <p>- OR -</p>
      <a href="<?php echo base_url(); ?>"#" class="btn btn-block btn-social btn-facebook btn-flat"><i class="fa fa-facebook"></i> Sign in using
        Facebook</a>
      <a href="<?php echo base_url(); ?>"#" class="btn btn-block btn-social btn-google btn-flat"><i class="fa fa-google-plus"></i> Sign in using
        Google+</a>
    </div> -->
    <!-- /.social-auth-links -->

    <a href="#">I forgot my password</a><br>
    <!-- <a href="<?php echo base_url(); ?>"register.html" class="text-center">Register a new membership</a> -->
